        ...
        <section className=" bg-white text-primary-color mt-0 py-0 item-center mb-28">
                        ...
                        <div className="flex flex-wrap items-center">
                            ...
                            <div className="w-full shrink-0 grow-0 basis-auto md:w-3/5">
                                <div className="px-6 py-12 md:px-12">
                                    <h5 className="mb-2 text-xl font-md tracking-tight text-primary-color">Now we are saving</h5>
                                    <h1 className="mb-4 text-3xl font-extrabold text-gray-900 md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">232,132 kgCO2</span></h1>
            ...
            <div className="container mx-auto md:px-6 mt-20 ">
                ...
                <div className="container mx-auto my-10 grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-2 font-BAI">
                    <div className="flex flex-col items-center p-8 rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
                    ...
                    <div className="flex flex-col items-center p-4 rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
