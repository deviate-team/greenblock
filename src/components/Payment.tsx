const Payment = () => {
    return (
        <div className="flex items-center justify-center px-5 pb-10 pt-16 font-BAI container mx-auto">
            <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700 max-w-">
