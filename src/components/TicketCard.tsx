                ...
                <div className="mt-4 bg-gray-100 flex flex-row flex-wrap md:flex-nowrap justify-between items-baseline">
                    <div className="flex mx-6 py-4 flex-row flex-wrap">
                        ...
                        <div className="flex justify-center mt-4">
                            <button className="w-32 h-11 rounded flex border-solid border bg-gray-500 text-white mx-2 justify-center place-items-center">Book</button>
                        </div>
                    </div>
                    <div className="md:border-l-2 mx-6 md:border-dotted flex flex-row py-4 mr-6 flex-wrap">
                        ...
                        <div className="flex justify-center items-center mt-4">
                            <button className="w-32 h-11 rounded border-solid border text-white bg-green-800 mx-2">Book</button>
                        </div>
                    </div>
                </div>
            </div>
