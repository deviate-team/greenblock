                        ...
                        <div className="flex-none sm:flex">
                            ...
                            <div className="flex-auto justify-evenly">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="ml-auto text-primary-color">A380</div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    <div className="flex flex-col">
                                        ...
                                        <div className="w-full flex-none text-lg text-primary-color font-bold leading-none">COK</div>
                                    ...
                                    <div className="flex flex-col ">
                                        ...
                                        <div className="w-full flex-none text-lg text-primary-color font-bold leading-none">DXB</div>
